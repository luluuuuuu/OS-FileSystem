...
public class DiskManager {
	...
	public DiskManager() {
		...
		this.bitMap = new byte[ConstValue.BLOCK_COUNT / 8];
		this.io = new IO();
		this.online = false;
	}
	...
	public int getFreeSpace(int length, int startBlockId) {
		startBlockId = Math.max(ConstValue.SYS_BLOCK_COUNT, startBlockId);
	...
	public String readFile(FCB fcb) {
		...
		return new String(resultBuffer.array(), ConstValue.CHARSET);
	}
